       ...
       public double Value { get; set; }
        ...
        public List<ConversionResponse> ConvertValues(ConversionRequest Request){
            ...
            if(Request.TypeToConvert == ConversionRequest.ValueType.Miles){
                ...
                response.Add(new ConversionResponse{Value=Request.Value, 
                                ValueType = Request.TypeToConvert.ToString()});

                response.Add(new ConversionResponse{Value=Request.Value*1.609, 
                ...
                response.Add(new ConversionResponse{Value= Request.Value, 
                            ValueType = Request.TypeToConvert.ToString()});
                response.Add(new ConversionResponse{Value=Request.Value*3.785412, 
